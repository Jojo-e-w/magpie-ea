...
const instructions = magpieViews.view_generator("instructions", {
  ...
  text: `Your intructions to for the experiment.
            <br />
            <br />
            In the following you will see pictures of a pair of geometrical figures. Your task is to decide if those to figures are the same or different. Please try to <strong>optimize your results in speed and accuracy<strong> :)`,
...
const practice = magpieViews.view_generator("key_press", {
  trails: trail_info.practice.length,
  name: 'practice',
  data: _.shuffel(trail_info.key_press_trails),
  pause: 250
});

//initialize main trails
const main = magpieViews.view_generator("key_press", {
  trails: trail_info.main.length,
  name: 'main',
  data: _.shuffel(trail_info.key_press_trails),
  pause: 250
});
